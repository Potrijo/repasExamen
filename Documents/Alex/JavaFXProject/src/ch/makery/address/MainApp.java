...
public class MainApp extends Application {
     ...
     */
    private ObservableList<EmpVO> personData = FXCollections.observableArrayList();
     ...
     * is returned.
     * 
     * @param selectedPerson the person object to be edited
     * @return true if the user clicked OK, false otherwise.
     */
    public boolean showPersonEditDialog(EmpVO selectedPerson) {
        try {
